    ...
    <TransitionRoot as="template" :show="open">
        <Dialog as="div" class="relative z-40" @close="close">
            ...
            <TransitionChild as="template"
                ...
                <div class="fixed inset-0 bg-yellow-500/30 bg-opacity-75 transition-opacity" />
            </TransitionChild>
                            ...
                            <DialogPanel class="pointer-events-auto w-screen max-w-2xl">
                                ...
                                <div class="flex h-full flex-col overflow-y-auto bg-slate-900 pb-6 shadow-xl">
                                    ...
                                    <div class="relative mt-6 flex-1 px-6">
                                        ...
                                        <div class="mt-4 flex flex-col gap-2 -ml-1">
                                    ...
                                    <!-- illustrations -->
                                    <div class="grid grid-cols-2 gap-2 px-6 mt-8">
                                    ...
                                    <!-- skills -->
                                    <div class="px-6 mt-8">
                                        <div class="text-lg text-slate-400">Stack technique</div>
                                        <div class="mt-2">
                                            <ul class="list-none p-0 m-0 grid xl:grid-cols-5 sm:grid-cols-4 grid-cols-3 ">
